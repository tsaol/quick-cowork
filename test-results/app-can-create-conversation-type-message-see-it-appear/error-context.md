...
- Name: app.spec.ts >> can create conversation, type message, see it appear
- Location: e2e/app.spec.ts:38:5
...
Locator: locator('[data-testid="chat-view"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="chat-view"]')
...
- button "Settings"
- main:
  - paragraph: Select or create a conversation to start
```
